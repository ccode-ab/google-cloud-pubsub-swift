...
public final class PubSubSubscriber {
    ...
    public typealias Handler = (Message) -> EventLoopFuture<Void>
        ...
        _ = driver.raw
            ...
            .map { response in
                ...
                for receivedMessage in response.receivedMessages {
                    ...
                    let message = Message(id: rawMessage.messageID, published: rawMessage.publishTime.date, data: rawMessage.data, attributes: rawMessage.attributes)
    ...
    public func subscribe(from subscription: Subscription, use handler: @escaping Handler) {
